	...
	$.ajax({
		...
		success: function(responseData, status, xhr) {
			if (window.location.protocol === "https:") {
				window.location = 'http://www.goldengenharia.com/clientServices.do?command=logoutClient&redirect=true';
			} else {
				window.location = 'https://23b8d.iluria.com/clientServices.do?command=logoutClient&redirect=true';
			}
		},
		error: function(xhr, status, error) {
		}
